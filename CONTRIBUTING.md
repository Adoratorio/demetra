...
Use [GitHub Issues](https://github.com/Adoratorio/demetra/issues). Include the package version,
...
Cover request and response envelopes, API errors, queue ordering, cache expiry and endpoint changes, including requests already in flight. Check uploads, headers, abort signals and timeouts. Use controlled fixtures for network tests and keep credentials and customer data out of examples.
